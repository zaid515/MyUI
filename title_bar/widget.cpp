	...
	: QMainWindow(parent)
{
    ...
    const QString style = "QPushButton{background-color: rgb(35, 35, 35);color: #ffffff;padding: "
                          "5px;border-radius: 0px;font: 15pt "
                          "Microsoft Sans Serif"
                          ";}QPushButton::hover{background - color : rgb(85, 85, "
                          "85);color:rgb(255,255,255);border-radius: 0px;padding: 5px;}";
